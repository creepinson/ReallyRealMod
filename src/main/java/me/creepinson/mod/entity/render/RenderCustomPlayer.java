...
import me.creepinson.mod.entity.render.model.ModelCustomPlayer;
...
public class RenderCustomPlayer extends RenderLivingBase<AbstractClientPlayer>
{
    ...
    public ModelCustomPlayer getMainModel()
    {
        return (ModelCustomPlayer)super.getMainModel();
    }
    ...
    {
        ModelCustomPlayer modelplayer = this.getMainModel();
