...
import me.creepinson.mod.block.ModBlocks;
import me.creepinson.mod.item.ModItems;
import me.creepinson.mod.playermechanics.PlayerMechanicsHandler;
...
public class Main {
	...
	public static final String MODID = "ttmod";
	...
	@SidedProxy(clientSide = "me.creepinson.mod.util.proxy.ClientProxy", serverSide = "me.creepinson.mod.util.proxy.CommomProxy")
